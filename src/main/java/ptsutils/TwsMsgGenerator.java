// RPC 5/5/11 9:39 AM Copied from EWrapperMsgF=Generator in ib sources,
// need to change some of the defs to make output more readable
...
public class TwsMsgGenerator extends AnyWrapperMsgGenerator {
